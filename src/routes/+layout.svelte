...
<div class="{ $mathematics ? 'visible' : 'hidden' }" style="position:absolute;width:100%;padding:10px;background:#f0f0f0;font-family:untitled-serif;display:flex;flex-flow:column;gap:2px;">
	...
	<p>- Structure :: <a href="https://www.gutenberg.org/files/5740/5740-pdf.pdf">Wittgenstein</a>, <a href="https://en.wikipedia.org/wiki/Nobuo_Yoneda">Yoneda</a></p>
	<p>- Concepts :: <a href="https://plato.stanford.edu/entries/nonexistent-objects/">Meinong</a>, <a href="https://www.phil.cmu.edu/projects/carnap/editorial/latex_pdf/1928-1e%20part1.pdf">Carnap</a>, <a href="https://www.saxelab.org/">Saxe</a> </p>
	<hr>
	<h3>Things</h3>
